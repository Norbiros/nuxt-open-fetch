...
For every client, NuxtOpenFetch generates four helpers in `#open-fetch`. Their names start with the PascalCase client name and accept an OpenAPI `operationId`:
